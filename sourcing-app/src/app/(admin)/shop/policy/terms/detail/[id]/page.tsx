  ...
  const loadPolicy = useCallback(async () => {
    try {
      ...
      if (data.success) {
        ...
        toast.error(data.error || '이용약관을 불러오는데 실패했습니다.')
        router.push('/shop/policy/terms')
      }
    } catch (error) {
      console.error('이용약관 조회 실패:', error)
      toast.error('이용약관을 불러오는데 실패했습니다.')
      router.push('/shop/policy/terms')
    } finally {
      setIsLoading(false)
    }
  ...
  return (
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="mb-8">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-2xl font-bold text-gray-900">이용약관 상세</h1>
      ...
      <ConfirmModal
        ...
        title="이용약관 삭제"
        message="이 이용약관을 삭제하시겠습니까? 이 작업은 되돌릴 수 없습니다."
        confirmText="삭제"
        variant="danger"
