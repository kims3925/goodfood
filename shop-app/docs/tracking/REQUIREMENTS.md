...
### 배경
- 주문량 기반 인기상품을 별도 페이지에서 강조하여 구매 전환율 향상
- 모바일 사용자의 인기상품 접근성 개선 필요
- 인기상품 외 다른 상품도 함께 노출하여 탐색 유도

### 요구사항
- 인기상품 API: 주문량 기준 상품 순위 산출
- 인기상품 페이지: TOP 10 + 일반상품 섹션 구성
- 모바일 네비: 중앙 플로팅 버튼으로 인기상품 진입점 제공
- 순위 뱃지: 1~3위 메달, 4위 이하 숫자 표시

### 완료 조건
- [x] 인기상품 API 개발 (/api/shop/popular)
- [x] 인기상품 페이지 개발 (/popular)
- [x] TOP 10 제한 및 순위 뱃지 표시
- [x] "이런 상품은 어때요?" 섹션 추가
- [x] 모바일 하단 네비에 인기 버튼 추가 (플로팅 스타일)
