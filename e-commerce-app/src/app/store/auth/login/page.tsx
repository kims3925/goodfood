        ...
        <div className="bg-white rounded-lg shadow-md p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex items-center justify-between text-sm">
              ...
              <Link href="/store/auth/forgot-password" className="text-[#FF6B6B] hover:underline">
                비밀번호 찾기
              </Link>
            </div>
          ...
          <div className="space-y-3">
            <button className="w-full py-3 border border-gray-300 rounded-md flex items-center justify-center gap-2 hover:bg-gray-50 transition">
          ...
          <p className="mt-6 text-center text-gray-600">
            아직 회원이 아니신가요?{' '}
            <Link href="/store/auth/signup" className="text-[#FF6B6B] font-medium hover:underline">
              회원가입
            </Link>
          </p>
        </div>
